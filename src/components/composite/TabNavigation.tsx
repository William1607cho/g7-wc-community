...
export const TabNavigation: React.FC<TabNavigationProps> = ({
  ...
  const getTabClasses = (tab: Tab) => {
    ...
    switch (variant) {
      case 'pills':
        return isActive
          ? `${baseClasses} bg-primary-600 dark:bg-primary-500 text-white rounded-lg`
      ...
      default:
        return isActive
          ? `${baseClasses} text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20 border-b-2 border-primary-600 dark:border-primary-400`
