// e2e:allow 편집기 ComponentRegistry 등록맵에 SlotContainer 추가(편집기 IIFE 번들 포함 — 헤더 슬롯 렌더). 편집기 캔버스 렌더는 Chrome MCP 라이브 실측 + Vitest 로 검증. 사용자 사이트 런타임 무변경.
/**
...
export const compositeComponents = {
  ...
  // 슬롯 컨테이너 — 모듈 주입 UI를 떙겨 렌더. 등록맵 누락 시
