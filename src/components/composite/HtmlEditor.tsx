      ...
      {!previewMode && (
        <Textarea
          ...
          className={`block w-full rounded-lg border px-3 py-2 text-sm placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-1 disabled:opacity-50 disabled:cursor-not-allowed ${
            isHtml
              ? 'font-mono bg-white dark:bg-gray-800 border-primary-300 dark:border-primary-600 text-gray-800 dark:text-gray-200 focus:border-primary-500 focus:ring-primary-500'
              : 'bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-primary-500 focus:ring-primary-500'
          }`}
        />
      )}
