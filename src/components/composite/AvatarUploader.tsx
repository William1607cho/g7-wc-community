    ...
    <Div className={`flex flex-col items-center gap-3 ${className}`} id={id} {...editorAttrs}>
      ...
      {showUploadConfirm && previewUrl ? (
        <Div className="relative">
          ...
          />
          <Div className="absolute inset-0 rounded-full bg-primary-500/20 border-2 border-primary-500 border-dashed" />
        </Div>
      ) : (
        <Avatar
      ...
      {!readOnly && (
        <Div className="w-[220px] flex flex-col items-center gap-2">
          ...
          {showUploadConfirm && pendingFile && (
            <Div className="w-full p-3 bg-primary-50 dark:bg-primary-950/50 border border-primary-200 dark:border-primary-800 rounded-lg">
              <Div className="flex items-center gap-2 mb-2">
                <Icon name="upload" size="sm" className="text-primary-600 dark:text-primary-400 shrink-0" />
              ...
              <Div className="text-xs text-primary-600 dark:text-primary-400 truncate mb-3" title={pendingFile.name}>
