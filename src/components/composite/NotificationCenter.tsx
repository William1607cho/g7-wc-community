              ...
              {onUnreadOnlyToggle && (
                ...
                >
                  <Input
                    ...
                    className="w-3.5 h-3.5 rounded border-gray-300 dark:border-gray-600 text-primary-600 dark:text-primary-400 focus:ring-primary-500 dark:focus:ring-primary-400 cursor-pointer"
                  />
                  ...
                  return (
                    <Div
                      ...
                      className={`group flex items-start gap-3 px-4 py-3 text-left border-b border-gray-100 dark:border-gray-700 transition-colors cursor-pointer ${
                        isUnread
                          ? 'bg-primary-50/70 dark:bg-primary-900/20 hover:bg-primary-50 dark:hover:bg-primary-900/30'
                    ...
                    >
                      {notification.iconName && (
                        <Icon
                          ...
                          className={`w-5 h-5 mt-0.5 flex-shrink-0 ${
                            isUnread ? 'text-primary-600 dark:text-primary-400' : 'text-gray-400 dark:text-gray-500'
                          }`}
                        />
                      )}
                      ...
                      <Div className="flex flex-col items-center gap-2 flex-shrink-0">
                        {isUnread && (
                          <Span className="w-2 h-2 bg-primary-500 dark:bg-primary-400 rounded-full mt-1.5" />
                        )}
                        {onDelete && (
                          <Button
                            onClick={(e) => {
